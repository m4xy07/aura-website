...
import { useMouse } from "../../../../../ui/cuicui/hooks/use-mouse/hook/use-mouse";
...
export const GradientCard = ({
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-px rounded-[19px] dark:bg-card-black-bg bg-neutral-100/80" />
      {children && (
        <div
          className={cn(
            "relative gird place-content-center border-white dark:border-neutral-950 bg-white/70 dark:bg-transparent max-h-fit rounded-[15px] overflow-hidden",
            className,
          )}
        >
          {children}
